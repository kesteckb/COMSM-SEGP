...
While all users enjoyed the core concept of the quiz – trying to guess the item with the lowest sugar – some described it as “too easy” and expressed concern that it could become repetitive quite quickly. Some also noted that certain meal choices seemed odd or “overly simplistic” to them – for example, jam and peanut butter – and that they would have preferred more realistic meals. As an improvement on these issues, multiple users suggested picking a combination of items from a range to create a low-sugar meal.

Finally, the scrolling on the quiz page was problematic. Some users found this annoying, and reported that it detracted from their engagement with the game. 
...
This was an area of reasonable success. The sugar content of wholemeal bread was a particular surprise for a majority of users, indicating that game had succeeded to a degree in educating its players. Some users felt that their future behaviour would be genuinely impacted, with one commenting that “I think it’ll prompt me to read the labels on food a bit more!”. However, those users who described themselves as health conscious reported that the game was unlikely to change their behaviour, given that they already factored in a low-sugar approach to their diets. 

4 out of 5 users stated that they would recommend the game, but 3 of those added that they would recommend it for children specifically, as they felt that it would likely be more informative for that particular demographic (rather than adults).  
